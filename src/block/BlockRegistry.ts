...
export class BlockRegistry {
    ...
    public static init(): void {
        ...
        this.create(5).name("Amethyst").texture(5).color(0.8, 0.9, 1.0).light(2.0, 0.8, 0.9, 1.0).fragmentation(0.05).register();
        
        this.create(6).name("Ruby").texture(6).color(1.0, 0.2, 0.2).light(2.0, 1.0, 0.1, 0.1).fragmentation(0.05).register();
